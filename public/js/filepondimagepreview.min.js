                        ...
                        DID_FINISH_CALCULATE_PREVIEWSIZE: function(e) {
                            ...
                            if (c) {
                                ...
                                if (
                                    ((s = c.file),
                                    !(
                                        ((h = window.navigator.userAgent.match(
                                            /Firefox\/([0-9]+)\./
                                        ))
                                            ? parseInt(h[1])
                                            : null) <= 58
                                                    ...
                                                    if (r) {
                                                        ...
                                                        (a.crop = r.getMetadata(
                                                            ...
                                                            t.query(
                                                                ...
                                                                ((a.dirty = !0),
                                                                (a.resize = r.getMetadata(
                                                                    "resize"
                                                                )),
                                                                (a.markup = r.getMetadata(
                                                                    "markup"
                                                                )));
                                                    }
                                                })({ root: t, props: i });

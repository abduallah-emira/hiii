...
<div class="topbar-left">
    <div class="">
        ...
        <a href="{{route('form')}}" class="logo"><img src="{{asset('images/logo.png')}}" height="20" alt="logo"></a>
    </div>
</div>
    ...
    <div id="sidebar-menu">
        <ul>
         ...
         <!-- <li class="menu-title">Main</li>
            ...
            <li>
                <a href="{{Route('create')}}" class="waves-effect"><i class="dripicons-calendar"></i><span> department</span></a>
            </li>
        <!--
            <li class="has_sub">
